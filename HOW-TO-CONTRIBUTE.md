# How to contribute English Indonesia Language pack
...
- [github_contributions.csv](https://github.com/mageplaza/magento-2-english-indonesia-language-pack/blob/master/github_contributions.csv) has been contributed by Mageplaza and Magento community.

- We will merge `github_contributions.csv` with [en_ID.csv](https://github.com/mageplaza/magento-2-english-indonesia-language-pack/blob/master/en_ID.csv). Your Magento 2 store will use this csv file.

So, you should contribute to [github_contributions.csv](https://github.com/mageplaza/magento-2-english-indonesia-language-pack/blob/master/github_contributions.csv) file.
...
#### Suggestions
- You can copy any part of `en_ID.csv` and paste to `github_contributions.csv` then translate it.
- Please do not copy all lines in `en_ID.csv`, we will not approve it in this case.
